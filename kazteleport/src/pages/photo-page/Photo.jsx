        ...
        <div className="w-full flex flex-col items-center my-8">
            {photo && !isLoading ? (
                <div className="w-full flex flex-col justify-center items-center">
                    ...
                    <div className="flex items-center justify-between max-w-[67.5rem] w-4/5 mb-4">
                        ...
                        <div className="flex space-x-4">
                            <button className="flex rounded-lg justify-center items-center p-3 shadow-md bg-white">
                                <svg
                                    width="25"
                                    height="23"
                                    viewBox="0 0 25 23"
                    ...
                    <div className="relative w-4/5 xl:w-auto flex justify-center h-[770px]">
                    ...
                    {showModal && (
                        <Modal imageUrl={photo.urls.full} onClose={closeModal} />
                    )}
                </div>
            ) : (
                <div>
